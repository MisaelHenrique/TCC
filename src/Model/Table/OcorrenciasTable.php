 ...
 * @property \App\Model\Table\ServidoresTable&\Cake\ORM\Association\BelongsTo $Servidores
...
class OcorrenciasTable extends Table
{
    ...
    public function buildRules(RulesChecker $rules)
    {
        ...
        $rules->add($rules->existsIn(['servidore_id'], 'Servidores'));
