...
class OcorrenciasController extends AppController
{
    ...
    {
        $this->paginate = [
            'contain' => ['Alunos', 'Servidores', 'TipoOcorrencias', 'Gravidades', 'Turnos', 'Medidas'],
        ];
    ...
    public function add()
    {
        ...
        $servidores = $this->Ocorrencias->Servidores->find('list', ['limit' => 200]);
        ...
        $this->set(compact('ocorrencia', 'alunos', 'servidores', 'tipoOcorrencias', 'gravidades', 'turnos', 'medidas'));
    }
